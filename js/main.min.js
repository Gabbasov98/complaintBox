$("._tab").click((function(){let t=$(this).parents("._tabs-parent"),a=$(this).attr("data-tab");$(t).find("._tab").removeClass("_active"),$(this).addClass("_active"),$(t).find(".tab-content").removeClass("_active"),$(t).find("."+a).addClass("_active")})),$("._tab2").click((function(){let t=$(this).parents("._tabs-parent2"),a=$(this).attr("data-tab");console.log($(t).find("."+a)),$(t).find("._tab2").removeClass("_active"),$(this).addClass("_active"),$(t).find(".tab-content2").removeClass("_active"),$(t).find("."+a).addClass("_active")})),$("[data-copy]").click((function(){let t=$(this).attr("data-copy"),a=$("<textarea>");$("body").append(a),a.val(t).select(),document.execCommand("copy"),a.remove()}));
